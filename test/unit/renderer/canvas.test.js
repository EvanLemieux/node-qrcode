...
test('CanvasRenderer render', (t) => {
	...
	t.notThrow(() => { canvasEl = CanvasRenderer.render(sampleQrData); },
	...
	t.throw(() => { canvasEl = CanvasRenderer.render(sampleQrData); },
...
test('CanvasRenderer render to provided canvas', (t) => {
	...
	t.notThrow(() => { CanvasRenderer.render(sampleQrData, canvasEl); },
...
test('CanvasRenderer renderToDataURL', (t) => {
	...
	t.notThrow(() => { url = CanvasRenderer.renderToDataURL(sampleQrData); },
		'Should not throw if canvas is not provided');
